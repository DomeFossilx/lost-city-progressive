import {
    ...
    teleportNear, randInt, findLocNear, findNpcByName, Items
...
export class StallThievingTask extends BotTask {
    ...
    private _hasFoodInInventory(player: Player): boolean {
        const foodIds = [Items.LOBSTER, Items.SWORDFISH, Items.SALMON, Items.TROUT, Items.SARDINE, Items.SHRIMP];
